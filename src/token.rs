...
impl TryFrom<&TokenKind> for &'static str {
    type Error = LexemeError;

    fn try_from(value: &TokenKind) -> Result<Self, Self::Error> {
        match value {
            TokenKind::LeftParen => Ok("("),
            TokenKind::RightParen => Ok(")"),
            TokenKind::LeftBrace => Ok("{"),
            ...
            TokenKind::Identifier(_) => Err(LexemeError::DynamicValue),
            TokenKind::String(_) => Err(LexemeError::DynamicValue),
            TokenKind::Number(_) => Err(LexemeError::DynamicValue),
            TokenKind::And => Ok("and"),
            TokenKind::Class => Ok("class"),
            TokenKind::Else => Ok("else"),
            TokenKind::False => Ok("false"),
            TokenKind::For => Ok("for"),
            TokenKind::Fun => Ok("fun"),
            TokenKind::If => Ok("if"),
            TokenKind::Nil => Ok("nil"),
            TokenKind::Or => Ok("or"),
            TokenKind::Print => Ok("print"),
            TokenKind::Return => Ok("return"),
            TokenKind::Super => Ok("super"),
            TokenKind::This => Ok("this"),
            TokenKind::True => Ok("true"),
            TokenKind::Var => Ok("var"),
            TokenKind::While => Ok("while"),
            TokenKind::Error(_) => Err(LexemeError::ErrorValue),
            TokenKind::Eof => Ok(" "),
        }
    }
}
